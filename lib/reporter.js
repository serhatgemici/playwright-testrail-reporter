...
const caseIdExtractor_1 = __importDefault(require("./caseIdExtractor"));
/**
    ...
    onBegin(config, suite) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!process.env.TESTRAIL_RUN_ID) {
                ...
                (0, logger_1.default)("Existing Test Run with ID " + process.env.TESTRAIL_RUN_ID + " will be used.. Updating the Test Run with latest Test Cases");
                yield updateTestRailRun(parseInt(process.env.TESTRAIL_RUN_ID));
            }
        });
    }
...
function addTestRailRun(projectId) {
    return __awaiter(this, void 0, void 0, function* () {
        const caseIds = yield (0, caseIdExtractor_1.default)(process.env.TESTS_DIRECTORY);
 ...
 * @returns
 */
function updateTestRailRun(runId) {
    return __awaiter(this, void 0, void 0, function* () {
        const caseIds = yield (0, caseIdExtractor_1.default)(process.env.TESTS_DIRECTORY);
        console.log('Case IDs:', caseIds);
        return yield api.updateRun(runId, {
            include_all: false,
            case_ids: caseIds,
        }).then((res) => {
            (0, logger_1.default)("TestRail run has been updated: " + process.env.TESTRAIL_HOST +
                "/index.php?/runs/view/" + res.id);
        }, (reason) => {
            (0, logger_1.default)("Failed to update the TestRail run: " + reason);
        });
    });
}
// /**
